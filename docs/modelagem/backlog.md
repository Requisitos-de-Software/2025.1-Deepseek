...
| História de usuário                                         | Requisito trabalhado | Prioridade |
| ------------------------------------------------------------| -------------------- | ---------- |
...
| HU36 – Exibir citações de fontes                              | #RF14, #ROF08                | Baixa           |
| HU10 – Citar fontes da web nas pesquisas                               | #RF14               | Baixa           |
...
| HU32 – Implementar memória de contexto persistente entre conversas                | #RF31                | Média           |
...
| HU07 – Interromper respostas em andamento                         | #RF19                |Baixa       |
| HU09 – Organizar conversas em pastas, listas ou temas   | #RF33                | Média           |
...
| HU12 – Inserir informações por comando de voz                                                            | #RF34               | Alta           |
...
| História de usuário                                         | Requisito trabalhado | Prioridade |
| ------------------------------------------------------------| -------------------- | ---------- |
| HU31 – Utilizar uma API Pública                                                       | #RF20               | Alta           |
| HU11 – Integração com plataformas externas | #RF37               | Média           |
...
| 31/05/2025 |  1.3   | (#B01) Criação e descrição dos épicos 1 a 4 (Funcionalidades de IA, Controle de Dados, Segurança, Funcionalidades do chat). Categorização das histórias de usuário 12 a 18. Adição da metodologia.| [`@Luiz`](https://github.com/luizfaria1989)   |  [@Davi Emanuel](https://github.com/daviRolvr) |
| 31/05/2025 |  1.4   | (#B01) Criação e descrição dos épicos 5 a 8. Categorização das histórias de usuário 19 a 30.| [`@Luiz`](https://github.com/luizfaria1989)   |  [@Davi Emanuel](https://github.com/) |
| 01/06/2025 |  1.5   | (#B01) Categorização das histórias de usuário 31 a 36.| [`@Luiz`](https://github.com/luizfaria1989)   |  [@](https://github.com/daviRolvr) |
| 01/06/2025 |  1.6   | (#B01) Categorização das histórias de usuário 01 a 06. Criação dos temas.| [`@Luiz`](https://github.com/luizfaria1989)   |  [@Davi Emanuel](https://github.com/daviRolvr) |
