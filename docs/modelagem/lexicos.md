...
| L-UC06-03 | Responder          | Ato de gerar uma resposta falada ao usuário.                             | Verbo          | Falar, Responder em voz          | UC06          |
| L-UC06-04 | Reconhecimento     | Processo de identificar o que foi dito pelo usuário.                     | Objeto         | Reconhecimento de fala           | UC06          |
| L-UC06-05 | Síntese de Voz     | Geração de fala artificial a partir de texto.                            | Objeto         | TTS (Text-to-Speech), Voz sintética | UC06       |
| L-UC06-06 | Acessibilidade     | Melhoria na usabilidade para pessoas com dificuldades de digitação.      | Objeto         | Inclusão, Usabilidade            | UC06          |
